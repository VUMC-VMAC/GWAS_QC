...
Usage:
SCRIPTNAME.sh -i [input_fileset] -o [output_stem] -f [sex_file] -R [ref_file_stem] -b [input genome build] -m [plink_memory_limit] -n -c -t
...
build=b37
related=false
while getopts 'o:i:f:R:b:m:ncth' flag; do
  case "${flag}" in
